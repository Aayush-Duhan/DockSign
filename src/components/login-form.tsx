            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="relative text-center">
                  ...
                  <span className="relative bg-black/80 px-4 text-sm text-white/60">
                    Or continue with
                  </span>
                </div>

                <div className="grid grid-cols-3 gap-3">
                  <Button variant="outline" type="button" className="bg-black/50 border-white/10 text-white/70 hover:bg-white/10 hover:text-white transition-colors">
                ...
                <div className="text-center text-sm text-white/60">
                  ...
                  <Link href="/signup" className="text-white underline underline-offset-4 hover:text-white/90 font-medium transition-colors">
                    Sign up
                  </Link>
                </div>
              </div>
